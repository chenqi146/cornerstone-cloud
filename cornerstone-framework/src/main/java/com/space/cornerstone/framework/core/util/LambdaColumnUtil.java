 ...
 *
 **/
public class LambdaColumnUtil<T> {

    private final static Map<String, Map<String, String>> ENTITY_COLUMN_MAP = new ConcurrentHashMap<>();

    public static <T> LambdaColumnUtil<T> lambda() {
        return new LambdaColumnUtil<>();
    }
